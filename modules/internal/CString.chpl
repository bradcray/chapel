...
//  }
  ...
  // locale as b
  inline proc =(ref a: c_string, b: string_ascii) {
  ...
  inline proc _cast(type t, x:c_string) where isBoolType(t)
  {
    ...
    return c_string_to_chpl_bool((x:string_ascii).strip().c_str()) : t;
  }
  ...
  inline proc _cast(type t, x:c_string) where t == int(8)
    return c_string_to_int8_t((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == int(16)
    return c_string_to_int16_t((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == int(32)
    return c_string_to_int32_t((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == int(64)
    return c_string_to_int64_t((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == uint(8)
    return c_string_to_uint8_t((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == uint(16)
    return c_string_to_uint16_t((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == uint(32)
    return c_string_to_uint32_t((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == uint(64)
    return c_string_to_uint64_t((x:string_ascii).strip().c_str());
  ...
  inline proc _cast(type t, x:c_string) where t == real(32)
    return c_string_to_real32((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == real(64)
    return c_string_to_real64((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == imag(32)
    return c_string_to_imag32((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == imag(64)
    return c_string_to_imag64((x:string_ascii).strip().c_str());
  ...
  inline proc _cast(type t, x:c_string) where t == complex(64)
    return c_string_to_complex64((x:string_ascii).strip().c_str());
  inline proc _cast(type t, x:c_string) where t == complex(128)
    return c_string_to_complex128((x:string_ascii).strip().c_str());
