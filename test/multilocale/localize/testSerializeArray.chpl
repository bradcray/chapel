// This RVF's the record in the event that we turn off the
// specialization for records with runtime types in the compiler and
// comment out the serialization routines for domains in the modules.
